...
const scaleOptions = [
  { val: 1, color: 'bg-red-500', ring: 'ring-red-500', size: 'w-8 h-8 sm:w-[60px] sm:h-[60px]', dot: 'w-2 h-2 sm:w-4 sm:h-4', label: 'Strongly Disagree' },
  { val: 2, color: 'bg-orange-500', ring: 'ring-orange-500', size: 'w-7 h-7 sm:w-[50px] sm:h-[50px]', dot: 'w-1.5 h-1.5 sm:w-3 sm:h-3', label: 'Disagree' },
  { val: 3, color: 'bg-amber-500', ring: 'ring-amber-500', size: 'w-6 h-6 sm:w-[40px] sm:h-[40px]', dot: 'w-1.5 h-1.5 sm:w-2.5 sm:h-2.5', label: 'Somewhat Disagree' },
  { val: 4, color: 'bg-zinc-300', ring: 'ring-zinc-300', size: 'w-5 h-5 sm:w-[30px] sm:h-[30px]', dot: 'w-1.5 h-1.5 sm:w-2 sm:h-2', label: 'Neutral' },
  { val: 5, color: 'bg-lime-500', ring: 'ring-lime-500', size: 'w-6 h-6 sm:w-[40px] sm:h-[40px]', dot: 'w-1.5 h-1.5 sm:w-2.5 sm:h-2.5', label: 'Somewhat Agree' },
  { val: 6, color: 'bg-green-500', ring: 'ring-green-500', size: 'w-7 h-7 sm:w-[50px] sm:h-[50px]', dot: 'w-1.5 h-1.5 sm:w-3 sm:h-3', label: 'Agree' },
  { val: 7, color: 'bg-emerald-600', ring: 'ring-emerald-600', size: 'w-8 h-8 sm:w-[60px] sm:h-[60px]', dot: 'w-2 h-2 sm:w-4 sm:h-4', label: 'Strongly Agree' },
];
